...
public enum DSFontRegistration {
    ...
    private static func registerFont(named fontName: String) {
        // Try Bundle.main first (Xcode project), then Bundle.module (Swift package)
        let fontURL: URL? = Bundle.main.url(forResource: fontName, withExtension: "ttf")
            ?? Bundle.main.url(forResource: fontName, withExtension: "otf")
