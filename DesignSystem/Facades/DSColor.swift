...
extension DSColor {
    ...
    // MARK: - Semantic Aliases for Container Backgrounds
    /// Primary container background (alias for white)
    public static var containerBackgroundPrimary: DSColor { containerBackgroundWhite }
    /// Secondary container background (alias for greige)
    public static var containerBackgroundSecondary: DSColor { containerBackgroundGreige }
}
...
// MARK: - Semantic Aliases (for component compatibility)

extension DSColor {
    // MARK: - Border Color Aliases
    /// Primary border color (alias for borderOnContainerDefault)
    public static var borderColorPrimary: DSColor { borderOnContainerDefault }
    /// Secondary border color (alias for borderOnContainerInactive)
    public static var borderColorSecondary: DSColor { borderOnContainerInactive }
    /// Tertiary border color (alias for borderOnContainerInactive)
    public static var borderColorTertiary: DSColor { borderOnContainerInactive }

    // MARK: - Icon Color Aliases
    /// Primary icon color
    public static var iconColorPrimary: DSColor { textOnSurfaceColorPrimary }
    /// Secondary icon color
    public static var iconColorSecondary: DSColor { textOnSurfaceColorSecondary }
    /// Tertiary icon color
    public static var iconColorTertiary: DSColor { textOnSurfaceColorTertiary }
    /// Inactive icon color
    public static var iconColorInactive: DSColor { textOnSurfaceColorInactive }
    /// Inverse icon color
    public static var iconColorInverse: DSColor { textOnSurfaceColorInverse }
    /// Accent icon color
    public static var iconColorAccent: DSColor { textOnSurfaceColorAccent }
    /// Success icon color
    public static var iconColorSuccess: DSColor { textOnSurfaceColorSuccess }
    /// Warning icon color
    public static var iconColorWarning: DSColor { textOnSurfaceColorWarning }
    /// Error icon color
    public static var iconColorError: DSColor { textOnSurfaceColorError }
    /// Informational icon color
    public static var iconColorInformational: DSColor { textOnSurfaceColorInformational }

    // MARK: - Text Color Aliases
    /// Danger text color (alias for error)
    public static var textOnSurfaceColorDanger: DSColor { textOnSurfaceColorError }
    /// Danger text on container color (alias for error)
    public static var textOnContainerColorDanger: DSColor { textOnContainerColorError }

    // MARK: - Surface Background Aliases
    /// Primary surface background
    public static var surfaceBackgroundPrimary: DSColor { backgroundSurfaceColorGreige }
    /// Secondary surface background
    public static var surfaceBackgroundSecondary: DSColor { backgroundSurfaceColorSecondary }
}
