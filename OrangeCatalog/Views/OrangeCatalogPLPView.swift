...
// MARK: - OrangeCatalogPLPView

/// Product listing view using DSPLPPod components with full filtering support.
/// Displays products in a scrollable list with subcategory filter pills and navigation to PIP.
struct OrangeCatalogPLPView: View {
    ...
    private var filterPanel: some View {
        DSPlpFilterPanel(
            ...
            filterPills: standardFilterPills,
    ...
    private var standardFilterPills: [DSFilterPillItem] {
        [
            DSFilterPillItem(
                text: "All Filters",
